    ...
    if(recnum >= 0  && recnum < 20)
      {
        ...
        userMessage ="  انت مساعد في تعلم الطالب درس حول أساليب التقويم التربوي قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة مفهوم أساليب التقويم التربوي";
      }
    ...
    if(recnum >= 40  && recnum < 60)
      {
        ...
        userMessage =" انت مساعد في تعلم الطالب درس حول أساليب التقويم التربوي قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة طرق ومراحل أساليب التقويم التربوي";
      }
    if(recnum >= 60  && recnum < 80)
      {
        ...
        userMessage ="  انت مساعد في تعلم الطالب درس حول أساليب التقويم التربوي قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة تصنيف أساليب التقويم التربوي";
      }
    if(recnum >= 80  && recnum < 100)
      {
        ...
        userMessage ="  انت مساعد في تعلم الطالب درس حول أساليب التقويم التربوي قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة التطبيقات العملية لأساليب التقويم التربوي";
      }
    if(recnum == 100 )
      {
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=inrfKg4Depw&t=11s');
        userMessage ="  انت مساعد في تعلم الطالب درس حول أساليب التقويم التربوي قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة  انهيت تعلم المحتوى  بنجاح عليك  متابعة التعلم والجهد ";
      }
      handleOutgoingChat();
  })
