...
//*****************************************test***************************************************
const quizData = [
      {question: "الأهداف التعليمية تركز فقط على نقل المعلومات إلى الطالب.",
        options: ["صح", "خطأ"],
        answer: "خطأ",
        feedback: "الهدف التعليمي لا يقتصر على نقل المعلومات؛ بل يشمل تنمية مهارات الطالب وقدرته على التفكير النقدي وحل المشكلات."},
      {question: "صياغة الأهداف السلوكية تسهم في تحسين أداء المعلم أثناء التخطيط للدروس.",
        options: ["صح", "خطأ"],
        answer: "صح",
        feedback: "صياغة الأهداف السلوكية تساعد المعلم على وضع خطة واضحة للدروس، وتحديد الأنشطة التعليمية المناسبة لتحقيق هذه الأهداف."},
      {question: "الأهداف التربوية تشمل تنمية الجوانب الوجدانية لدى الطلاب.",
        options: ["صح", "خطأ"],
        answer: "صح",
        feedback: "الأهداف التربوية تهتم بتنمية جميع الجوانب الشخصية للطالب، بما في ذلك الوجدانية والاجتماعية، وليس فقط المعرفية."},
      {question: "يمكن قياس جميع الأهداف التربوية بنفس الطرق المستخدمة لقياس الأهداف التعليمية. ",
        options: ["صح", "خطأ"],
        answer: "خطأ",
        feedback: "الأهداف التربوية قد تتطلب وسائل قياس مختلفة، مثل ملاحظة السلوك أو التقييم الذاتي، لقياس جوانب مثل القيم والمواقف."},
      {question: "استخدام الأفعال القابلة للقياس في صياغة الأهداف السلوكية يسهم في تحسين وضوحها وتوجيهها. ",
        options: ["صح", "خطأ"],
        answer: "صح",
        feedback: "استخدام أفعال مثل يعرّف، يحلل، ويصنف في الأهداف السلوكية يسهم في جعلها أكثر وضوحًا ويُسهل قياس تحققها."},
      {question: "الأهداف السلوكية تُكتب دائمًا لتتضمن مستوى التحليل فقط من تصنيف بلوم. ",
        options: ["صح", "خطأ"],
        answer: "خطأ",
        feedback: "الأهداف السلوكية يمكن أن تشمل مستويات مختلفة من تصنيف بلوم، مثل المعرفة والفهم والتطبيق، وليس فقط التحليل. "},
      {question: "يجب أن تكون الأهداف التعليمية عامة وغير محددة لتكون شاملة لجميع الطلاب. ",
        options: ["صح", "خطأ"],
        answer: "خطأ",
        feedback: "من الأفضل أن تكون الأهداف التعليمية محددة وقابلة للقياس، حتى يمكن التأكد من تحقيقها بوضوح."},
      {question: "يمكن أن يحتوي الهدف التربوي على أبعاد وجدانية وأخرى معرفية في نفس الوقت. ",
        options: ["صح", "خطأ"],
        answer: "صح",
        feedback: "الهدف التربوي يمكن أن يشمل أبعادًا متعددة، مثل الجوانب الوجدانية والمعرفية، لتحقيق تنمية شاملة للطالب."},
      {question: "تصنيف بلوم لا يتضمن مستويات تطبيقية مثل التركيب والتقويم. ",
        options: ["صح", "خطأ"],
        answer: "خطأ",
        feedback: "تصنيف بلوم يتضمن مستويات مثل التطبيق، التحليل، التركيب، والتقويم، إلى جانب المعرفة والفهم."},
      {question: " الأهداف السلوكية يجب أن تُصاغ بطريقة تتيح للمعلم وللطالب التحقق من تحققها.",
        options: ["صح", "خطأ"],
        answer: "صح",
        feedback: " من الضروري أن تكون الأهداف السلوكية قابلة للتحقق من خلال أدوات قياس واضحة، مما يساعد في تقييم مدى تحقيق الأهداف."}   
];
...
// API configuration
const API_KEY = "AIzaSyAQy_o_gjYaecksodrqDiXivS9xv0mJCQY"; // Your API key here
...
btnback.addEventListener('click', () => 
  {
    ...
    if(recnum >= 0  && recnum < 20)
      {
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=4955D0RFU0k&list=PPSV');
        userMessage ="  انت مساعد في تعلم الطالب درس حول مفهوم التصميم التعليمي قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة مفهوم صياغة الأهداف";
      }
    if(recnum >= 20  && recnum < 40)
      {
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=4955D0RFU0k&list=PPSV');
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=-XF1wMRqqp4');
        userMessage ="  انت مساعد في تعلم الطالب درس حول مفهوم التصميم التعليمي قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة مفهوم صياغة الأهداف";
      }
    if(recnum >= 40  && recnum < 60)
      {
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=AZQhRdsGZZo');
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=4955D0RFU0k&t=4s');
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=Xoqvja-oWTg');
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=-2d4T2f0CW8');
        userMessage =" انت مساعد في تعلم الطالب درس حول مفهوم التصميم التعليمي قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة طرق ومراحل صياغة الأهداف";
      }
    if(recnum >= 60  && recnum < 80)
      {
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=W1cS_0LUG2M');
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=5ckoEyF4OqU');
        userMessage ="  انت مساعد في تعلم الطالب درس حول مفهوم التصميم التعليمي قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة تصنيف بلوم للاهداف التعليمية";
      }
    if(recnum >= 80  && recnum < 100)
      {
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=PsFPB5XRN3E&list=PPSV');
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=hkWXd1F6AM4&list=PPSV');
        userMessage ="  انت مساعد في تعلم الطالب درس حول مفهوم التصميم التعليمي قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة التطبيقات العملية للاهداف التعليمية";
      }
    if(recnum == 100 )
      {
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=-uMCAtGXX4I');
        userMessage ="  انت مساعد في تعلم الطالب درس حول التصميم التعليمي قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة الدرس التالي";
      }
      handleOutgoingChat();
  })
