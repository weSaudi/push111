    ...
    if(recnum >= 0  && recnum < 20)
      {
        ...
        userMessage ="  انت مساعد في تعلم الطالب درس حول مفهوم التصميم التعليمي قم بكتابة عبارة واحدة توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة مفهوم صياغة الأهداف";
      }
    ...
    if(recnum >= 40  && recnum < 60)
      {
        ...
        userMessage =" انت مساعد في تعلم الطالب درس حول مفهوم التصميم التعليمي قم بكتابة عبارة واحدة توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة طرق ومراحل صياغة الأهداف";
      }
    if(recnum >= 60  && recnum < 80)
      {
        ...
        userMessage ="  انت مساعد في تعلم الطالب درس حول مفهوم التصميم التعليمي قم بكتابة عبارة واحدة توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة تصنيف بلوم للاهداف التعليمية";
      }
    if(recnum >= 80  && recnum < 100)
      {
        ...
        userMessage ="  انت مساعد في تعلم الطالب درس حول مفهوم التصميم التعليمي قم بكتابة عبارة واحدة توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة التطبيقات العملية للاهداف التعليمية";
      }
    if(recnum == 100 )
      {
