    ...
    if(recnum >= 0  && recnum < 20)
      {
        ...
        userMessage ="  انت مساعد في تعلم الطالب درس حول مفهوم التصميم التعليمي قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة مفهوم التصميم التعليمي";
      }
    if(recnum >= 20  && recnum < 40)
      {
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=01E4C1WMTrE');
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=g0-RRrraRQk');
        userMessage ="  انت مساعد في تعلم الطالب درس حول مفهوم التصميم التعليمي قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة مفهوم التصميم التعليمي";
      }
    if(recnum >= 40  && recnum < 60)
      {
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=mr9WGICpikU');
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=ItYvYx3zszY');
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=hkwOQ4DAxKI');
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=lWK6vbWReII');
        userMessage ="  انت مساعد في تعلم الطالب درس حول مفهوم التصميم التعليمي قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة أهمية التصميم التعليمي";
      }
    if(recnum >= 60  && recnum < 80)
      {
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=8wT-krjU1ok');
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=inrfKg4Depw');
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=6poK7RbEHrw');
        userMessage ="  انت مساعد في تعلم الطالب درس حول مفهوم التصميم التعليمي قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة مزايا التصميم التعليمي";
      }
    if(recnum >= 80  && recnum < 100)
      {
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=XhvOFQo4Ixk');
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=Gg23WerMhqU');
        userMessage ="  انت مساعد في تعلم الطالب درس حول مفهوم التصميم التعليمي قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة مكونات التصميم التعليمي";
      }
    if(recnum == 100 )
      {
