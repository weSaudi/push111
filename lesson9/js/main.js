    ...
    if(recnum >= 0  && recnum < 20)
      {
        ...
        userMessage ="  انت مساعد في تعلم الطالب درس حول كتابة السيناريو التعليمي قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة مفهوم كتابة السيناريو التعليمي";
      }
    if(recnum >= 20  && recnum < 40)
      {
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=Pm0v3EcTxLU&t=1347s');
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=z_KGHTC-o2M');
        userMessage ="  انت مساعد في تعلم الطالب درس حول كتابة السيناريو التعليمي قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة كتابة السيناريو التعليمي";
      }
    if(recnum >= 40  && recnum < 60)
      {
        ...
        userMessage =" انت مساعد في تعلم الطالب درس حول كتابة السيناريو التعليمي قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة طرق ومراحل كتابة السيناريو التعليمي";
      }
    if(recnum >= 60  && recnum < 80)
      {
        ...
        userMessage ="  انت مساعد في تعلم الطالب درس حول كتابة السيناريو التعليمي قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة تصنيف كتابة السيناريو التعليمي";
      }
    if(recnum >= 80  && recnum < 100)
      {
        ...
        userMessage ="  انت مساعد في تعلم الطالب درس حول كتابة السيناريو التعليمي قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة التطبيقات العملية لكتابة السيناريو التعليمي";
      }
    if(recnum == 100 )
      {
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=hZMLSUao0Gg');
        userMessage ="  انت مساعد في تعلم الطالب درس حول كتابة السيناريو التعليمي  قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة الدرس التالي";
      }
      handleOutgoingChat();
  })
