    ...
    if(recnum >= 0  && recnum < 20)
      {
        ...
        userMessage ="  انت مساعد في تعلم الطالب درس حول استراتيجيات التدريس الحديثة قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة مفهوم استراتيجيات التدريس الحديثة";
      }
    if(recnum >= 20  && recnum < 40)
      {
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=c--bv2QdRM4');
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=DJbNLsyPm0Q');
        userMessage ="  انت مساعد في تعلم الطالب درس حول مفهوم استراتيجيات التدريس الحديثة قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة مفهوم استراتيجيات التدريس الحديثة";
      }
    if(recnum >= 40  && recnum < 60)
      {
        ...
        userMessage =" انت مساعد في تعلم الطالب درس حول مفهوم استراتيجيات التدريس الحديثة قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة طرق ومراحل استراتيجيات التدريس الحديثة";
      }
    if(recnum >= 60  && recnum < 80)
      {
        ...
        userMessage ="  انت مساعد في تعلم الطالب درس حول مفهوم استراتيجيات التدريس الحديثة قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة تصنيف استراتيجيات التدريس الحديثة";
      }
    if(recnum >= 80  && recnum < 100)
      {
        ...
        userMessage ="  انت مساعد في تعلم الطالب درس حول مفهوم استراتيجيات التدريس الحديثة قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة التطبيقات العملية لاستراتيجيات التدريس الحديثة";
      }
    if(recnum == 100 )
      {
        addListItem('قم بدراسة المحتوى', 'https://www.youtube.com/watch?v=Pm0v3EcTxLU&t=1347s');
        userMessage ="  انت مساعد في تعلم الطالب درس حول استراتيجيات التدريس الحديثة قم بكتابة توصية توجه فيها الطالب نحو دراسة المحتوى تبدء بعبارة عليك دراسة الدرس التالي";
      }
      handleOutgoingChat();
  })
